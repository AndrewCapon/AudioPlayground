...
set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports lrclkOut]
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports dataOut]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports bclkOut]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports mclkOut]

set_property -dict {PACKAGE_PIN R3 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[0]}]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[1]}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[2]}]
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[3]}]
set_property -dict {PACKAGE_PIN T2 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[4]}]
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[5]}]
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[6]}]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[7]}]

set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports intr1]
set_property -dict {PACKAGE_PIN V3 IOSTANDARD LVCMOS33} [get_ports intr2]
set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS33} [get_ports intr3]
#set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[11]}]


#set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[8]}]
#set_property -dict {PACKAGE_PIN V3 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[9]}]
#set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[10]}]
#set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {debug_tri_o[11]}]
