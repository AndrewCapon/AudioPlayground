...
#define XPAR_PROCESSOR_MICROBLAZE_0_COMPONENT_NAME AudioPlatformLocalMem_microblaze_0_0
...
#define XPAR_MICROBLAZE_COMPONENT_NAME AudioPlatformLocalMem_microblaze_0_0
