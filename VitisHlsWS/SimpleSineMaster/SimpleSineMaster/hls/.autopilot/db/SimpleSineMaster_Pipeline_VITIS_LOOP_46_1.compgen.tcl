...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_46_1_sine_lut_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    id 2 \
    name accumulator_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_accumulator_load \
    op interface \
    ports { accumulator_load { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_phaseInc \
    op interface \
    ports { phaseInc { I 32 vector } } \
} "
}
...
set InstName SimpleSineMaster_flow_control_loop_pipe_sequential_init_U
set CompName SimpleSineMaster_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix SimpleSineMaster_ \
}"
} else {
