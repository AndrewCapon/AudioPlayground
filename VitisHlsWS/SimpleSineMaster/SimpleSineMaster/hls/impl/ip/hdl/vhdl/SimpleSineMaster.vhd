...
architecture behav of SimpleSineMaster is 
    ...
    component SimpleSineMaster_control_s_axi IS
    generic (
    ...
    component SimpleSineMaster_gmem_m_axi IS
    generic (
...
begin
    ...
    gmem_m_axi_U : component SimpleSineMaster_gmem_m_axi
    generic map (
        CONSERVATIVE => 1,
        USER_MAXREQS => 4,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                ...
                trunc_ln_reg_171 <= samples(31 downto 2);
            end if;
        end if;
    end process;
    ...
    ap_ST_fsm_state9_blk_assign_proc : process(gmem_0_BVALID)
    begin
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state9, gmem_0_BVALID)
    begin
        if (((gmem_0_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state9, gmem_0_BVALID)
    begin
        if (((gmem_0_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
