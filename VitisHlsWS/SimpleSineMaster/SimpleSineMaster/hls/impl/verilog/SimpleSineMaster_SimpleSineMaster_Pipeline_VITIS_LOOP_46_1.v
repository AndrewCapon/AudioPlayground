...
module SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_46_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_46_1_sine_lut_ROM_AUTO_1R #(
    .DataWidth( 24 ),
    .AddressRange( 4096 ),
    .AddressWidth( 12 ))
sine_lut_U(
...
always @ (*) begin
    if (((icmp_ln46_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln49_fu_146_p2 = (empty_fu_66 + phaseInc);

assign address_fu_151_p4 = {{add_ln49_fu_146_p2[31:20]}};
...
assign icmp_ln46_fu_132_p2 = ((ap_sig_allocacmp_block1_load == 6'd47) ? 1'b1 : 1'b0);
...
assign sine_lut_address0 = zext_ln56_fu_161_p1;

assign zext_ln56_fu_161_p1 = address_fu_151_p4;

endmodule //SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_46_1
