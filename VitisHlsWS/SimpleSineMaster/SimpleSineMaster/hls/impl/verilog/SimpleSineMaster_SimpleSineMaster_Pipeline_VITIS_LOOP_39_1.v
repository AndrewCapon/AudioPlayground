...
module SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_39_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [23:0] sine_lut_load_reg_214;
wire   [31:0] zext_ln44_fu_161_p1;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [5:0] block1_fu_62;
wire   [5:0] block_fu_126_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_block1_load;
wire    ap_block_pp0_stage0;
reg   [31:0] empty_fu_66;
wire   [31:0] add_ln42_fu_146_p2;
reg    sine_lut_ce0_local;
wire   [11:0] address_fu_151_p4;
reg    ap_done_reg;
...
SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_39_1_sine_lut_ROM_AUTO_1R #(
    .DataWidth( 24 ),
    .AddressRange( 4096 ),
    .AddressWidth( 12 ))
sine_lut_U(
...
SimpleSineMaster_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
always @ (*) begin
    if (((icmp_ln39_fu_132_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln42_fu_146_p2 = (empty_fu_66 + phaseInc);

assign address_fu_151_p4 = {{add_ln42_fu_146_p2[31:20]}};
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end
...
assign block_fu_126_p2 = (ap_sig_allocacmp_block1_load + 6'd1);

assign icmp_ln39_fu_132_p2 = ((ap_sig_allocacmp_block1_load == 6'd47) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_0_WDATA = sine_lut_load_reg_214;

assign m_axi_gmem_0_WID = 1'd0;

assign m_axi_gmem_0_WLAST = 1'b0;

assign m_axi_gmem_0_WSTRB = 4'd7;

assign m_axi_gmem_0_WUSER = 1'd0;

assign sine_lut_address0 = zext_ln44_fu_161_p1;

assign zext_ln44_fu_161_p1 = address_fu_151_p4;

endmodule //SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_39_1
