...
entity MultiSineStream_control_s_axi is
generic (
...
end entity MultiSineStream_control_s_axi;
...
architecture behave of MultiSineStream_control_s_axi is
    ...
    constant ADDR_PHASEINC_BASE : INTEGER := 16#20#;
    constant ADDR_PHASEINC_HIGH : INTEGER := 16#3f#;
    ...
    component MultiSineStream_control_s_axi_ram is
        generic (
    ...
    end component MultiSineStream_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_phaseInc
int_phaseInc : MultiSineStream_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_phaseInc_read = '0') else '0';
    RVALID    <= RVALID_t;
...
entity MultiSineStream_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity MultiSineStream_control_s_axi_ram;

architecture behave of MultiSineStream_control_s_axi_ram is
