...
// ==============================================================
`timescale 1ns/1ps
module MultiSine_control_s_axi
#(parameter
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [2:0]                    int_phaseInc_address0;
    wire                          int_phaseInc_ce0;
    wire [31:0]                   int_phaseInc_q0;
    wire [2:0]                    int_phaseInc_address1;
    wire                          int_phaseInc_ce1;
    wire                          int_phaseInc_we1;
    wire [3:0]                    int_phaseInc_be1;
    wire [31:0]                   int_phaseInc_d1;
...
//------------------------Memory logic-------------------
// phaseInc
assign int_phaseInc_address0 = phaseInc_address0;
assign int_phaseInc_ce0      = phaseInc_ce0;
assign phaseInc_q0           = int_phaseInc_q0;
assign int_phaseInc_address1 = ar_hs? raddr[4:2] : waddr[4:2];
assign int_phaseInc_ce1      = ar_hs | (int_phaseInc_write & WVALID);
...
assign int_samples_address1  = ar_hs? raddr[10:2] : waddr[10:2];
assign int_samples_ce1       = ar_hs;
// int_phaseInc_read
always @(posedge ACLK) begin
    if (ARESET)
        int_phaseInc_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_PHASEINC_BASE && raddr <= ADDR_PHASEINC_HIGH)
            int_phaseInc_read <= 1'b1;
        else
            int_phaseInc_read <= 1'b0;
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_PHASEINC_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_PHASEINC_HIGH)
...
module MultiSine_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
