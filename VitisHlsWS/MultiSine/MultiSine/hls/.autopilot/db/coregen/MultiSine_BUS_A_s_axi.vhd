...
entity MultiSine_BUS_A_s_axi is
generic (
...
end entity MultiSine_BUS_A_s_axi;
...
architecture behave of MultiSine_BUS_A_s_axi is
    ...
    component MultiSine_BUS_A_s_axi_ram is
        generic (
    ...
    end component MultiSine_BUS_A_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_phaseInc
int_phaseInc : MultiSine_BUS_A_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
entity MultiSine_BUS_A_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity MultiSine_BUS_A_s_axi_ram;

architecture behave of MultiSine_BUS_A_s_axi_ram is
