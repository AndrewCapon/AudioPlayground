; ModuleID = '/home/andrewcapon/fpga/ArtixA7/AudioPlatform/AudioPlatformHlsWS/MultiSine/MultiSine/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MultiSine_ir(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="8" %phaseInc, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="384" %samples) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_MultiSine_hw([8 x i32]* %phaseInc_copy, [384 x i24]* %samples_copy)
...
declare void @apatb_MultiSine_hw([8 x i32]*, [384 x i24]*)
...
declare void @MultiSine_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull)

define void @MultiSine_hw_stub_wrapper([8 x i32]*, [384 x i24]*) #5 {
entry:
  ...
  call void @MultiSine_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %6, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* %7)
