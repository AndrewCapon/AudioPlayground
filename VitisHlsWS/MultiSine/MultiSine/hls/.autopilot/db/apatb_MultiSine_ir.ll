; ModuleID = '/home/andrewcapon/fpga/ArtixA7/AudioPlayground/VitisHlsWS/MultiSine/MultiSine/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MultiSine_ir(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="8" %phaseInc, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="384" %samples, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="48" %debug) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_MultiSine_hw([8 x i32]* %phaseInc_copy, [384 x i24]* %samples_copy, [48 x i32]* %debug_copy)
...
declare void @apatb_MultiSine_hw([8 x i32]*, [384 x i24]*, [48 x i32]*)
...
declare void @MultiSine_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull, i32* noalias nocapture nonnull readonly)

define void @MultiSine_hw_stub_wrapper([8 x i32]*, [384 x i24]*, [48 x i32]*) #5 {
entry:
  ...
  call void @MultiSine_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %7, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* %8, i32* %9)
