; ModuleID = '/home/andrewcapon/fpga/ArtixA7/AudioPlayground/VitisHlsWS/MultiSineStreamBidirectional/MultiSineStreamBidirectional/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MultiSineStreamBidirectional_ir(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nonnull "fpga.decayed.dim.hint"="8" %phaseInc, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nonnull "fpga.decayed.dim.hint"="384" %samples) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_MultiSineStreamBidirectional_hw([8 x i32]* %phaseInc_copy, [384 x i24]* %samples_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a8struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>.37"([8 x i32]* align 512 %1, [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %0)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a384struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>.27"([384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %2, [384 x i24]* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a384struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>.27"([384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* noalias "unpacked"="0" %dst, [384 x i24]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a384struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>.30"([384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* nonnull %dst, [384 x i24]* %src, i64 384)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a384struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>.30"([384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* "unpacked"="0" %dst, [384 x i24]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a8struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>.37"([8 x i32]* noalias nocapture align 512 "unpacked"="0.0" %dst, [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a8struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>.40"([8 x i32]* %dst, [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 8)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a8struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>.40"([8 x i32]* nocapture "unpacked"="0.0" %dst, [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
declare void @apatb_MultiSineStreamBidirectional_hw([8 x i32]*, [384 x i24]*)
...
declare void @MultiSineStreamBidirectional_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nonnull, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nonnull)

define void @MultiSineStreamBidirectional_hw_stub_wrapper([8 x i32]*, [384 x i24]*) #5 {
entry:
  ...
  call void @MultiSineStreamBidirectional_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %6, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* %7)
