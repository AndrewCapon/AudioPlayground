set moduleName SimpleSineStreamBidirectional_Pipeline_VITIS_LOOP_44_1
set isTopModule 0
...
set cdfgNum 3
set C_modelName {SimpleSineStreamBidirectional_Pipeline_VITIS_LOOP_44_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ accumulator int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "accumulator", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outputs_TREADY sc_in sc_logic 1 outacc 2 } 
	{ accumulator sc_in sc_lv 32 signal 0 } 
	{ phaseInc sc_in sc_lv 32 signal 1 } 
	{ outputs_TDATA sc_out sc_lv 32 signal 2 } 
	{ outputs_TVALID sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "accumulator", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "accumulator", "role": "default" }} , 
...
set Spec2ImplPortList { 
	accumulator { ap_none {  { accumulator in_data 0 32 } } }
	phaseInc { ap_none {  { phaseInc in_data 0 32 } } }
	outputs { axis {  { outputs_TREADY out_acc 0 1 }  { outputs_TDATA out_data 1 32 }  { outputs_TVALID out_vld 1 1 } } }
}
