...
entity SimpleSineStreamBidirectional_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity SimpleSineStreamBidirectional_regslice_both;

architecture behave of SimpleSineStreamBidirectional_regslice_both is
