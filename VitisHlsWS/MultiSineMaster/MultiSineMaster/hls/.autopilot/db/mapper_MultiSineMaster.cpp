...
__xlx_phaseInc_samples__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_phaseInc)[i]);
}
  int __xlx_size_param_phaseInc = 8;
  int __xlx_offset_param_phaseInc = 0;
  int __xlx_offset_byte_param_phaseInc = 0*4;
for (size_t i = 0; i < 384; ++i){
__xlx_phaseInc_samples__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_samples)[i]);
}
