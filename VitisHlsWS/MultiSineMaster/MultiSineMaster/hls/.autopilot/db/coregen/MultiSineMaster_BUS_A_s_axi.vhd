...
entity MultiSineMaster_BUS_A_s_axi is
generic (
...
end entity MultiSineMaster_BUS_A_s_axi;
...
architecture behave of MultiSineMaster_BUS_A_s_axi is
    ...
    component MultiSineMaster_BUS_A_s_axi_ram is
        generic (
    ...
    end component MultiSineMaster_BUS_A_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_debug
int_debug : MultiSineMaster_BUS_A_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_debug_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_debug_be0        <= (others => debug_we0);
    int_debug_d0         <= RESIZE(UNSIGNED(debug_d0), 32);
...
entity MultiSineMaster_BUS_A_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity MultiSineMaster_BUS_A_s_axi_ram;

architecture behave of MultiSineMaster_BUS_A_s_axi_ram is
