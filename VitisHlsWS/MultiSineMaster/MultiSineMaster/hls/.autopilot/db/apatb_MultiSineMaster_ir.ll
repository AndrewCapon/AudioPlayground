; ModuleID = '/home/andrewcapon/fpga/ArtixA7/AudioPlatform/AudioPlatformHlsWS/MultiSineMaster/MultiSineMaster/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_MultiSineMaster_ir(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nonnull "fpga.decayed.dim.hint"="8" "maxi" %phaseInc, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="384" "maxi" %samples, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="48" %debug) local_unnamed_addr #0 {
entry:
  ...
  %2 = bitcast i32* %debug to [48 x i32]*
  %debug_copy = alloca [48 x i32], align 512
  call fastcc void @copy_in([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* nonnull %0, [8 x i32]* nonnull align 512 %phaseInc_copy, [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* nonnull %1, [384 x i24]* nonnull align 512 %samples_copy, [48 x i32]* nonnull %2, [48 x i32]* nonnull align 512 %debug_copy)
  call void @apatb_MultiSineMaster_hw([8 x i32]* %phaseInc_copy, [384 x i24]* %samples_copy, [48 x i32]* %debug_copy)
  call void @copy_back([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %0, [8 x i32]* %phaseInc_copy, [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %1, [384 x i24]* %samples_copy, [48 x i32]* %2, [48 x i32]* %debug_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="0", [8 x i32]* noalias nocapture align 512 "unpacked"="1.0", [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* noalias readonly "unpacked"="2", [384 x i24]* noalias nocapture align 512 "unpacked"="3.0", [48 x i32]* noalias readonly "unpacked"="4", [48 x i32]* noalias align 512 "unpacked"="5") unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a48i32([48 x i32]* align 512 %5, [48 x i32]* %4)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @onebyonecpy_hls.p0a48i32([48 x i32]* noalias align 512 %dst, [48 x i32]* noalias readonly %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [48 x i32]* %dst, null
  %1 = icmp eq [48 x i32]* %src, null
  %2 = or i1 %0, %1
  br i1 %2, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a48i32([48 x i32]* nonnull %dst, [48 x i32]* nonnull %src, i64 48)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a48i32([48 x i32]* %dst, [48 x i32]* readonly %src, i64 %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [48 x i32]* %src, null
  %1 = icmp eq [48 x i32]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr = getelementptr [48 x i32], [48 x i32]* %dst, i64 0, i64 %for.loop.idx2
  %src.addr = getelementptr [48 x i32], [48 x i32]* %src, i64 0, i64 %for.loop.idx2
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="0", [8 x i32]* noalias nocapture readonly align 512 "unpacked"="1.0", [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* noalias "unpacked"="2", [384 x i24]* noalias nocapture readonly align 512 "unpacked"="3.0", [48 x i32]* noalias "unpacked"="4", [48 x i32]* noalias readonly align 512 "unpacked"="5") unnamed_addr #4 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a48i32([48 x i32]* %4, [48 x i32]* align 512 %5)
  ret void
}
...
declare void @apatb_MultiSineMaster_hw([8 x i32]*, [384 x i24]*, [48 x i32]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="0", [8 x i32]* noalias nocapture readonly align 512 "unpacked"="1.0", [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* noalias "unpacked"="2", [384 x i24]* noalias nocapture readonly align 512 "unpacked"="3.0", [48 x i32]* noalias "unpacked"="4", [48 x i32]* noalias readonly align 512 "unpacked"="5") unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a8struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %0, [8 x i32]* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0a384struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>.26"([384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %2, [384 x i24]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0a48i32([48 x i32]* %4, [48 x i32]* align 512 %5)
...
declare void @MultiSineMaster_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nonnull, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nocapture nonnull, i32* noalias nocapture nonnull)

define void @MultiSineMaster_hw_stub_wrapper([8 x i32]*, [384 x i24]*, [48 x i32]*) #5 {
entry:
  %3 = call i8* @malloc(i64 32)
  %4 = bitcast i8* %3 to [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]*
  %5 = call i8* @malloc(i64 1536)
  %6 = bitcast i8* %5 to [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]*
  call void @copy_out([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %4, [8 x i32]* %0, [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %6, [384 x i24]* %1, [48 x i32]* null, [48 x i32]* %2)
  %7 = bitcast [8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %4 to %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"*
  %8 = bitcast [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %6 to %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"*
  %9 = bitcast [48 x i32]* %2 to i32*
  call void @MultiSineMaster_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %7, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* %8, i32* %9)
  call void @copy_in([8 x %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"]* %4, [8 x i32]* %0, [384 x %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"]* %6, [384 x i24]* %1, [48 x i32]* null, [48 x i32]* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
}
