...
// ==============================================================
`timescale 1ns/1ps
module MultiSineMaster_BUS_A_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER        = 9'h008,
    ADDR_ISR        = 9'h00c,
    ADDR_DEBUG_BASE = 9'h100,
    ADDR_DEBUG_HIGH = 9'h1ff,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
//------------------------Instantiation------------------
// int_debug
MultiSineMaster_BUS_A_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "S2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 48 )
...
assign RVALID  = (rstate == RDDATA) & !int_debug_read;
...
assign int_debug_be0      = {4{debug_we0}};
assign int_debug_d0       = debug_d0;
assign int_debug_address1 = ar_hs? raddr[7:2] : waddr[7:2];
assign int_debug_ce1      = ar_hs;
// int_debug_read
always @(posedge ACLK) begin
    if (ARESET)
        int_debug_read <= 1'b0;
...
module MultiSineMaster_BUS_A_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
