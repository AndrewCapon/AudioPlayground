...
// ==============================================================
`timescale 1ns/1ps
module MultiSineStream_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER           = 6'h08,
    ADDR_ISR           = 6'h0c,
    ADDR_PHASEINC_BASE = 6'h20,
    ADDR_PHASEINC_HIGH = 6'h3f,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
//------------------------Instantiation------------------
// int_phaseInc
MultiSineStream_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 8 )
...
assign RVALID  = (rstate == RDDATA) & !int_phaseInc_read;
...
module MultiSineStream_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
