...
// wrapc file define:
#define AUTOTB_TVIN_phaseInc "../tv/cdatafile/c.MultiSineStream.autotvin_phaseInc.dat"
#define AUTOTB_TVOUT_phaseInc "../tv/cdatafile/c.MultiSineStream.autotvout_phaseInc.dat"
#define AUTOTB_TVIN_samples "../tv/cdatafile/c.MultiSineStream.autotvin_samples.dat"
#define AUTOTB_TVOUT_samples "../tv/cdatafile/c.MultiSineStream.autotvout_samples.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_samples "../tv/rtldatafile/rtl.MultiSineStream.autotvout_samples.dat"
...
extern "C"
void MultiSineStream_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_MultiSineStream_hw(void* __xlx_apatb_param_phaseInc, void* __xlx_apatb_param_samples)
{
  ...
  port0.param = __xlx_apatb_param_samples;
  port0.nbytes = 1536;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_phaseInc),
#else
  ...
  try {
    ...
    MultiSineStream_hw_stub_wrapper(__xlx_apatb_param_phaseInc, __xlx_apatb_param_samples);
