...
entity MultiSineStreamBidirectional_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity MultiSineStreamBidirectional_regslice_both;

architecture behave of MultiSineStreamBidirectional_regslice_both is
