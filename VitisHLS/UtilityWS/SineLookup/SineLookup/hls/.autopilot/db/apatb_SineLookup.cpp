...
// wrapc file define:
#define AUTOTB_TVIN_phaseIndex "../tv/cdatafile/c.SineLookup.autotvin_phaseIndex.dat"
#define AUTOTB_TVOUT_phaseIndex "../tv/cdatafile/c.SineLookup.autotvout_phaseIndex.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.SineLookup.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.SineLookup.autotvout_ap_return.dat"
...
extern "C"
void SineLookup_hw_stub_wrapper(hls::sim::Byte<4>*, hls::sim::Byte<4>*);

extern "C"
void apatb_SineLookup_hw(hls::sim::Byte<4>* ap_return, hls::sim::Byte<4>* __xlx_apatb_param_phaseIndex)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_phaseIndex),
#endif
  };
  port1.param = __xlx_apatb_param_phaseIndex;
  ...
  try {
    ...
    SineLookup_hw_stub_wrapper(ap_return, __xlx_apatb_param_phaseIndex);
