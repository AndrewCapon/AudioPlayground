...
#define CONTROL_ADDR_ACCUMULATOR_I_DATA 0x010
#define CONTROL_BITS_ACCUMULATOR_I_DATA 32
#define CONTROL_ADDR_ACCUMULATOR_O_DATA 0x018
#define CONTROL_BITS_ACCUMULATOR_O_DATA 32
#define CONTROL_ADDR_ACCUMULATOR_O_CTRL 0x01c
#define CONTROL_ADDR_PHASEINC_DATA      0x020
#define CONTROL_BITS_PHASEINC_DATA      32
#define CONTROL_ADDR_SAMPLES_BASE       0x100
#define CONTROL_ADDR_SAMPLES_HIGH       0x1ff
#define CONTROL_WIDTH_SAMPLES           24
#define CONTROL_DEPTH_SAMPLES           48
