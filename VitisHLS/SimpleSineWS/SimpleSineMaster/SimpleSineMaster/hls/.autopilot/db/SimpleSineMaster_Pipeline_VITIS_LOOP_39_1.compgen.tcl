...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler SimpleSineMaster_SimpleSineMaster_Pipeline_VITIS_LOOP_39_1_sine_lut_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
