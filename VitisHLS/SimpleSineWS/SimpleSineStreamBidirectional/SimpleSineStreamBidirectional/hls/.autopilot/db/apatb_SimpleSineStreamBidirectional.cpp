...
// wrapc file define:
#define AUTOTB_TVIN_inputs "../tv/cdatafile/c.SimpleSineStreamBidirectional.autotvin_inputs.dat"
#define AUTOTB_TVOUT_inputs "../tv/cdatafile/c.SimpleSineStreamBidirectional.autotvout_inputs.dat"
#define AUTOTB_TVIN_outputs "../tv/cdatafile/c.SimpleSineStreamBidirectional.autotvin_outputs.dat"
#define AUTOTB_TVOUT_outputs "../tv/cdatafile/c.SimpleSineStreamBidirectional.autotvout_outputs.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_outputs "../tv/rtldatafile/rtl.SimpleSineStreamBidirectional.autotvout_outputs.dat"
...
extern "C"
void SimpleSineStreamBidirectional_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_SimpleSineStreamBidirectional_hw(void* __xlx_apatb_param_inputs, void* __xlx_apatb_param_outputs)
{
  ...
  port0.param = __xlx_apatb_param_inputs;
  port0.nbytes = 8;
  ...
  static hls::sim::A2Stream port1 {
    ...
    .name = "outputs",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outputs),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_outputs),
    .iwriter = nullptr,
#endif
    .hasWrite = true,
  };
  port1.param = __xlx_apatb_param_outputs;
  port1.nbytes = 196;
  ...
  try {
    ...
    SimpleSineStreamBidirectional_hw_stub_wrapper(__xlx_apatb_param_inputs, __xlx_apatb_param_outputs);
