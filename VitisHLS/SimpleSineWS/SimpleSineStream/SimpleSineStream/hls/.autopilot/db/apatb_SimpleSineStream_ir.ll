; ModuleID = '/home/andrewcapon/fpga/ArtixA7/AudioPlayground/VitisHlsWS/SimpleSineStream/SimpleSineStream/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_SimpleSineStream_ir(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull dereferenceable(4) %accumulator, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* nocapture readonly %phaseInc, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nonnull "fpga.decayed.dim.hint"="48" %samples) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_SimpleSineStream_hw(i32* %accumulator_copy, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %phaseInc, [48 x i24]* %samples_copy)
...
declare void @apatb_SimpleSineStream_hw(i32*, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"*, [48 x i24]*)
...
declare void @SimpleSineStream_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* nocapture readonly, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* noalias nonnull)

define void @SimpleSineStream_hw_stub_wrapper(i32*, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"*, [48 x i24]*) #5 {
entry:
  ...
  call void @SimpleSineStream_hw_stub(%"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %4, %"struct.ap_ufixed<32, 0, AP_TRN, AP_WRAP, 0>"* %1, %"struct.ap_fixed<24, 1, AP_RND, AP_SAT, 0>"* %7)
